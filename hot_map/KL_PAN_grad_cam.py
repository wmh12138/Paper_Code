...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', default='30_KL_grad_cam.png', type=str, help='saved image name')
    ...
    #PATH = 'D:\Desktop\GradCAM-master\KL_PAN_Blood_Model_params.pkl'
    #model.load_state_dict(torch.load(PATH, map_location=torch.device('cpu')))
    model = torch.load('D:\Desktop\GradCAM-master\KL_PAN_Blood_Model_20.pkl',map_location=torch.device('cpu'))
    model.eval()
